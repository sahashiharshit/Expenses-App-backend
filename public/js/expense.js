...
async function addExpenses(event) {
  ...
  try {
    ...
    const response = await axios.post(
      "http://3.111.41.143:3000/expense/add",
      {
        money: money,
...
async function fetchExpenses(page=1,limit=10) {
  try {
    ...
    const response = await axios.get(
      "http:///3.111.41.143:3000/expense/getExpenses",
      {params:
      { 
      page:page,
      limit:limit,
...
async function buyPremium(e) {
  const token = localStorage.getItem("AuthToken");
  const response = await axios.get(
    "http://3.111.41.143:3000/purchase/premiummembership",
    { headers: { Authorization: token } }
  );
  ...
  const options = {
    ...
    handler: async function (response) {
      await axios.post(
        "http://3.111.41.143:3000/purchase/updatetransactionstatus",
        {
  ...
  rzp1.on("payment.failed", async function (res) {
    await axios.post(
      "http://3.111.41.143:3000/purchase/updatefailedtransactionstatus",
      {
...
async function checkPremiumMembership(token) {
  const status = await axios.get(
    "http://3.111.41.143:3000/purchase/checkpremium",
    { headers: { Authorization: token } }
  );
...
async function deleteExpense(expenseId, money) {
  try {
    ...
    const response = await axios.delete(
      `http://3.111.41.143:3000/expense/deleteExpense/${expenseId}`,
...
async function downloadfile() {
  const token = localStorage.getItem("AuthToken");
  try {
    const response = await axios.get("http://3.111.41.143:3000/premium/download", {
      headers: { Authorization: token },
    });
...
async function showOldReports() {
  ...
  try {
    const response = await axios.get(
      "http://3.111.41.143:3000/premium/oldReports",
      {
        headers: { Authorization: token },
      }
    );
